...
export function ContactCta() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    // Convert data array values into clean browser form params to bypass CORS blocks
    ...
    try {
      ...
      if (response.ok) {
        ...
        throw new Error(errData.error || "Submission failed. Please check your Form ID.")
      }
    } catch (err: any) {
      setErrorMessage("Message delivery failed. Please check your connection or try again.")
    } finally {
        ...
        <div className="overflow-hidden rounded-[2rem] bg-navy">
          <div className="grid gap-10 p-8 sm:p-12 lg:grid-cols-2 lg:gap-16 lg:p-16">
            ...
            <div className="relative rounded-2xl bg-background p-6 sm:p-8">
              {isSuccess ? (
                /* IN-PAGE SUCCESS BLOCK — Stays on site, no redirections */
                <div className="flex flex-col items-center justify-center text-center h-full py-12">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground max-w-xs">
                    Thank you for reaching out. Your request has been transmitted securely. Our team will review your project parameters and respond shortly to info@nexorasolutionsrw.qzz.io.
                  </p>
                  <button 
