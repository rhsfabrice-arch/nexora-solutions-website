...
export function ContactCta() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    // 🟢 FAIL-PROOF PAYLOAD: Passing native FormData object directly.
    // This matches Formspree's core expectations and eliminates any JSON formatting errors.
    const formData = new FormData(e.currentTarget)

    try {
      const response = await fetch("https://formspree.io/f/mlgyddor", {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        ...
        throw new Error("Formspree rejected the submission packet.")
      }
    } catch (err: any) {
